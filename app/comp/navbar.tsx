      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            <Link
              href="/deepanalysis"
              className="text-[#6b7582] hover:text-[#121417] transition-colors"
            >
              Deepfake Analysis
            </Link>
            <Link
            ...
            <Button
              variant="outline"
              className="bg-[#ffffff] text-[#121417] border-[#dee0e3] hover:bg-[#f2f2f5]"
            >
              <Link href="/signup">Get Started</Link>
            </Button>
            <Button className="bg-[#121417] text-[#ffffff] hover:bg-[#121417]/90">
              {" "}
          ...
          <div className="block lg:hidden">
            <Sheet>
              <SheetTrigger>
                <Button className="pb-3 rotate-90 px-3">|||</Button>
              </SheetTrigger>
              <SheetContent>
                {/* <SheetHeader> */}
